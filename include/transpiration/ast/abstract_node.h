#ifndef AST_ABSTRACT_NODE_H_
#define AST_ABSTRACT_NODE_H_
...
// forward declaration of Visitor interface from transpiration/visitor/IVisitor.h
class IVisitor;
